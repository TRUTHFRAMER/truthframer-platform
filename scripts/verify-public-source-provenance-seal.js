...
function fail(msg) {
  console.error(`TRUTHFRAMER_PUBLIC_SOURCE_PROVENANCE_SEAL_FAIL=${msg}`);
  process.exit(1);
}
...
if (seal.status !== "PUBLIC_SOURCE_PROVENANCE_CERTIFIED_SEALED") fail("SEAL_STATUS_MISMATCH");
if (seal.certificate_sha256 !== sha256File(certPath)) fail("CERTIFICATE_HASH_MISMATCH");

console.log("TRUTHFRAMER_PUBLIC_SOURCE_PROVENANCE_SEAL_PASS=true");
